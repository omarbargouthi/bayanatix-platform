  ...
  if (data.length < 2) {
    return (
      <div className="h-[150px] flex flex-col items-center justify-center text-muted text-sm gap-1">
        <span>No trend history yet</span>
        <span className="text-xs">Capture a snapshot to start building the trend line.</span>
      </div>
    );
  }
