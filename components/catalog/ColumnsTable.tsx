...
function ColumnDetail({ attr, onEdit, canEdit }: { attr: DataAttribute; onEdit: () => void; canEdit: boolean }) {
  ...
  return (
    <div className="bg-canvas-soft border-b border-line px-6 py-4 space-y-4">
      ...
      {/* Custom attributes — only renders once an admin defines fields for columns */}
      <CustomAttributesPanel assetType="DATA_ATTRIBUTES" assetId={attr.attributeId} canEdit={canEdit} />
