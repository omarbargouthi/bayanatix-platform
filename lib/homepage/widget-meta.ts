...
import { IconBell, IconFlag, IconShield, IconSearch, IconTable, IconLines, IconHistory } from "@/components/layout/icons";
...
export type WidgetTitleKey = "needsAction" | "myRequests" | "stewardDomains" | "quickLinks" | "savedSearches" | "recentAssets" | "followedActivity";
...
export const WIDGET_META: Record<string, WidgetMeta> = {
  ...
  followed_activity: { key: "followed_activity", titleKey: "followedActivity", icon: IconHistory },
};

export const DEFAULT_WIDGET_KEYS = ["needs_action", "my_requests", "steward_domains", "quick_links", "followed_activity"];
