...
import { FoiReportClient } from "./FoiReportClient";
import { getServerT } from "@/lib/i18n/server";

export const dynamic = "force-dynamic";

export default async function FoiReportPage() {
    ...
    <>
      <Header
        crumbs={[
          ...
          { label: t.reports.foi.title },
        ]}
        user={user}
      />
      <FoiReportClient domains={domains} sources={sources} owners={owners} isAdmin={user.role === "ADMIN"} domainLocked={scope.restricted} />
    </>
  );
}
