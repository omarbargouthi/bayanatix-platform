...
import { PiAccessReportClient } from "./PiAccessReportClient";

export const dynamic = "force-dynamic";

export default async function PiAccessReportPage() {
    ...
    <>
      <Header
        crumbs={[
          ...
          { label: "PI Access by Role" },
        ]}
        user={user}
      />
      <PiAccessReportClient domains={domains} sources={sources} owners={owners} isAdmin={user.role === "ADMIN"} domainLocked={scope.restricted} />
    </>
  );
}
